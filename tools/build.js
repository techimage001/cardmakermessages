...
function appBody() {
  ...
  return `<section class="app-shell"><div class="container"><div class="app-intro"><p class="eyebrow">No design experience needed</p><h1>Create a beautiful card without being a designer</h1><p>Choose an occasion, edit every line, tap a complete design, select the exact size and review the finished result before any file opens.</p></div><p id="resumeNotice" class="resume-notice" hidden>Picked up where you left off. Start again whenever you need a blank card.</p>
  <div class="step-tabs" role="navigation" aria-label="Card creation steps"><button class="step-tab" type="button" data-step="1">1. Message</button><button class="step-tab" type="button" data-step="2">2. Design</button><button class="step-tab" type="button" data-step="3">3. Size, review &amp; download</button></div>
  <div id="cardMakerWorkspace" class="app-grid"><aside class="preview-column"><div class="preview-card"><div class="panel-tabs" aria-label="Card panels"><button type="button" data-panel="front">Front</button><button type="button" data-panel="inside-left">Inside left</button><button type="button" data-panel="inside-right">Inside right</button><button type="button" data-panel="back">Back</button></div><div class="canvas-wrap"><canvas id="cardCanvas" role="img" aria-label="Live preview of your personalised card"></canvas></div><p id="previewCaption" class="preview-caption">Front cover. Live preview.</p></div></aside>
  ...
  <div data-step-panel="2" hidden><div data-editor-slot="2"></div>
    ...
    </div><div class="step-footer"><button class="button" type="button" data-prev-step>Back</button><button class="button button-primary" type="button" data-next-step>Choose size and review</button></div></div>
  <div data-step-panel="3" hidden><div data-editor-slot="3"></div>
    <div id="outputFormatSection" class="control-section format-before-review"><p class="eyebrow">Choose before reviewing</p><h2>Where will you use the card?</h2><p class="help">The preview changes to the exact shape you select.</p><div class="choice-grid output-mode-grid"><button type="button" class="choice" data-output-mode="digital">Digital and social</button><button type="button" class="choice" data-output-mode="single-print">One-page print</button><button type="button" class="choice" data-output-mode="folded">Folded card</button></div>
      ...
      <div class="selected-format-card"><span>Selected format</span><strong id="selectedFormatSummary"></strong></div>
    </div>
    <div class="control-section review-first"><p class="eyebrow">Review before saving</p><h2>See the exact finished size first</h2><p>Review the selected digital shape, flat print page or every panel of the folded card. Download and sharing choices appear only after this check.</p><button id="reviewCard" class="button button-primary button-large primary-download" type="button">Review selected format</button></div>
    <div id="downloadWorkspace" class="download-workspace" hidden><div class="download-card"><span>Reviewed format</span><strong id="downloadSummary"></strong><small>Change any size above and review again before exporting.</small></div>
      <div id="digitalActions" class="control-section download-actions"><h2>Download or share the digital card</h2><button id="downloadPng" type="button" class="button button-primary button-large primary-download">Open high-resolution PNG</button><div class="secondary-actions"><button id="downloadJpg" class="button" type="button">Open JPG</button><button id="shareImage" class="button" type="button">Share card image</button><button id="copyImage" class="button" type="button">Copy image</button><button id="copyMessage" class="button" type="button">Copy message</button></div><h3>Share the card-maker link</h3><p class="help">Social links can share the page and message. Use Share card image above when you want to attach the finished picture.</p><div class="social-share-grid"><button id="whatsappShare" class="button" type="button">WhatsApp</button><button id="facebookShare" class="button" type="button">Facebook</button><button id="linkedinShare" class="button" type="button">LinkedIn</button><button id="xShare" class="button" type="button">X</button><button id="pinterestShare" class="button" type="button">Pinterest</button><button id="emailShare" class="button" type="button">Email</button><button id="shareLink" class="button" type="button">Share or copy link</button></div></div>
      <div id="singlePrintActions" class="control-section download-actions" hidden><h2>Open the printable card</h2><button id="downloadSinglePdf" type="button" class="button button-primary button-large primary-download">Open one-page printable PDF</button><p class="info-note">The PDF opens for inspection before you save or print it.</p></div>
      <div id="foldedActions" class="control-section download-actions" hidden><h2>Open the folded card</h2><button id="downloadPdf" type="button" class="button button-primary button-large primary-download">Open folded card PDF</button><p class="info-note">The outside and inside sheets open as a two-page PDF. The inside remains white or warm ivory by default.</p></div>
    </div><div class="step-footer"><button class="button" type="button" data-prev-step>Back to design</button><button id="startAgainBottom" class="button button-quiet" type="button">Start another card</button></div></div>
  ${editor}</section></div></div></section>
  <aside id="floatingPreviewDock" class="floating-preview-dock" hidden aria-label="Floating card preview"><canvas id="floatingCardCanvas" role="img" aria-label="Small live preview of your card"></canvas><button id="returnToEditor" type="button" class="button button-primary button-small">Back to card editor</button></aside>
  ...
  <div class="modal-backdrop" id="reviewModal" hidden><section class="review-modal" role="dialog" aria-modal="true" aria-labelledby="reviewTitle"><button class="modal-close" id="closeReview" type="button" aria-label="Close card review">×</button><p class="eyebrow">Complete card preview</p><h2 id="reviewTitle" tabindex="-1">Review the selected format</h2><p id="reviewFormatSummary" class="review-format-summary"></p><div id="reviewSingleWrap" class="review-single"><figure><canvas data-review-single></canvas><figcaption>Finished front design at the selected shape</figcaption></figure></div><div id="reviewFoldedWrap" class="review-grid" hidden><figure><canvas data-review-panel="front"></canvas><figcaption>Front</figcaption></figure><figure><canvas data-review-panel="inside-left"></canvas><figcaption>Inside left</figcaption></figure><figure><canvas data-review-panel="inside-right"></canvas><figcaption>Inside right</figcaption></figure><figure><canvas data-review-panel="back"></canvas><figcaption>Back</figcaption></figure></div><div class="button-row"><button class="button" id="editFromReview" type="button">Change size or edit</button><button class="button button-primary" id="continueFromReview" type="button">Use this format</button></div></section></div>`;
}
