...
check(app.includes('Share both sheets') && app.includes('Outside sheet PNG') && app.includes('Inside sheet JPEG'), 'Folded image sharing and downloads are incomplete');
...
check(app.includes('Shares the finished image plus the CardMakerMessages.com link') && app.includes('Share card image sends the finished image plus the CardMakerMessages.com link.'), 'share panels must clearly state that the image and website link are sent together');
check(app.includes('/assets/site-v18-1.js') && app.includes('/assets/messages-v18-1.js') && app.includes('/assets/pdf-v18-1.js') && app.includes('/assets/app-v18-2.js'), 'app.html must load the isolated corrected V18.2 scripts');
...
check(appSource.includes("I made this card on CardMakerMessages.com. Create yours too:\\nhttps://cardmakermessages.com"), 'Approved share message is missing from the sharing function');
